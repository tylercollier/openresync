  ...
  <div class="tw-flex tw-justify-between tw-items-center tw-py-2 tw-px-4 tw-text-white" style="background: #0a3d5b;">
    ...
    <div class="tw-flex">
      ...
      <div class="tw-mr-8 tw-font-bold">
        <router-link class="tw-mr-8 tw-text-white" :style="styles('/dashboard')" to="/dashboard">Dashboard</router-link>
        <router-link to="/cron" class="tw-mr-4 tw-text-white" :style="styles('/cron')">Cron Schedules</router-link>
