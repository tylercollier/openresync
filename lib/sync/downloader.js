...
module.exports = function(mlsSourceName, configBundle, eventEmitter, loggerArg) {
  ...
  if (platformAdapterName === 'bridgeInteractive') {
    ...
    platformAdapter = require('./platformAdapters/mlsGrid')()
  } else {
  ...
  function makeUrl(mlsResourceObj, timestamps, batchTimestamp, top, batchAlreadyExisted, indexes) {
    ...
    // TODO: This is for MlsGrid. Perhaps a bug that they properly don't support (potentially unnecessary) parens?
