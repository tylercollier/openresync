...
module.exports = function(mlsSourceName, configBundle, internalEventEmitter, loggerArg) {
  ...
  async function downloadMlsMetadata() {
    try {
      ...
      emitToAll('ors:downloader.download_metadata.error', e)
      throw e
    }
  }
  ...
  async function downloadMlsResources() {
    try {
      ...
      emitToAll('ors:downloader.download_sync.error', e)
      throw e
    }
  }
  ...
  async function downloadPurgeData() {
    try {
      ...
      emitToAll('ors:downloader.download_purge.error', e)
      throw e
    }
  }
  ...
  async function downloadReconcileData() {
    try {
      ...
      emitToAll('ors:downloader.download_reconcile.error')
      throw e
    }
  }
  ...
  async function downloadMissingData() {
    try {
      ...
      emitToAll('ors:downloader.download_missing.error')
      throw e
    }
  }
