...
module.exports = function(mlsSourceName, configBundle, internalEventEmitter, loggerArg) {
  ...
  async function downloadMlsMetadata() {
    try {
      ...
      emitToAll(ORS_DOWNLOADER_DOWNLOAD_METADATA_ERROR, e)
      throw e
    }
  }
  ...
  async function downloadMlsResources() {
    try {
      ...
      emitToAll(ORS_DOWNLOADER_DOWNLOAD_SYNC_ERROR, e)
      throw e
    }
  }
  ...
  async function downloadPurgeData() {
    try {
      ...
      emitToAll(ORS_DOWNLOADER_DOWNLOAD_PURGE_ERROR, e)
      throw e
    }
  }
  ...
  async function downloadReconcileData() {
    try {
      ...
      emitToAll(ORS_DOWNLOADER_DOWNLOAD_RECONCILE_ERROR, e)
      throw e
    }
  }
  ...
  async function downloadMissingData() {
    try {
      ...
      emitToAll(ORS_DOWNLOADER_DOWNLOAD_MISSING_ERROR, e)
      throw e
    }
  }
