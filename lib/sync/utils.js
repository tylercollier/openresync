...
async function getSourceFiles(userConfig, mlsSourceName) {
  const filesPerMlsResource = await Promise.all(userConfig.sources[mlsSourceName].mlsResources.map(mlsResourceObj => getMlsResourceDirFiles(mlsSourceName, mlsResourceObj.name)))
...
async function deleteSourceFilesForBatch(userConfig, mlsSourceName, batchType, batchId, logger) {
