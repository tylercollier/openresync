...
const paragonOpenMlsPlatformAdapter = require('../platformAdapters/paragon_openmls')
...
const paragonOpenMlsMysqlPlatformDataAdapter = require('../platformDataAdapters/paragon_openmls/mysql')
...
function buildDataAdapter({ destinationConfig, platformAdapterName }) {
  ...
  } else if (platformAdapterName === 'paragon_openmls') {
