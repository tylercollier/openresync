...
const sparkPlatformAdapter = require('../platformAdapters/spark')
...
const sparkMysqlPlatformDataAdapter = require('../platformDataAdapters/spark/mysql')
...
function buildDataAdapter({ destinationConfig, platformAdapterName }) {
  ...
  } else if (platformAdapterName === 'spark') {
    platformAdapter = sparkPlatformAdapter()
  } else {
  ...
  if (dataAdapterType === 'mysql') {
    if (platformAdapterName === 'bridgeInteractive') {
      ...
      platformDataAdapter = sparkMysqlPlatformDataAdapter()
    } else {
