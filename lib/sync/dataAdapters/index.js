...
const crmlsPlatformAdapter = require('../platformAdapters/crmls')
...
const crmlsMysqlPlatformDataAdapter = require('../platformDataAdapters/crmls/mysql')
...
function buildDataAdapter({ destinationConfig, platformAdapterName }) {
  ...
  } else if (platformAdapterName === 'crmls') {
    platformAdapter = crmlsPlatformAdapter()
  ...
  if (dataAdapterType === 'mysql') {
    if (platformAdapterName === 'bridgeInteractive') {
      ...
      platformDataAdapter = crmlsMysqlPlatformDataAdapter()
    } else if (platformAdapterName === 'mlsGrid') {
