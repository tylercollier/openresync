...
const ORS_SYNC_DESTINATION_DONE = 'ors:sync.destination.done'
...
module.exports = function(db) {
  ...
  function syncDestinationDone(syncDestinationId) {
  ...
  function listen(eventEmitter) {
    ...
    ee.on(ORS_SYNC_DESTINATION_DONE, stuffit(ORS_SYNC_DESTINATION_DONE))
    ...
    (async () => {
      ...
      for await (const { eventName, args } of generator()) {
        ...
        } else if (eventName === ORS_SYNC_DESTINATION_DONE) {
          await syncDestinationDone(syncDestinationId)
        } else {
